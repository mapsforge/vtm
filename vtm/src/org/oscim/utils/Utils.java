...
public final class Utils {
    ...
    public static TextureItem loadTexture(String relativePathPrefix, String src, int width, int height, int percent) {
        ...
        try {
            ...
            if (bitmap != null) {
                ...
                return new TextureItem(getPotBitmap(bitmap), true);
            }
        } catch (Exception e) {
    ...
    /**
     * Returns a Bitmap with POT size, if {@link Parameters}.POT_TEXTURES == true!
     * Else the returned Bitmap is the same instance of given Bitmap!
     *
     * If the given Bitmap have POT size, the given instance is returned!
     *
     * @param bitmap
     * @return
     */
    public static Bitmap getPotBitmap(Bitmap bitmap) {
