...
public class ExtrusionStyle extends RenderStyle<ExtrusionStyle> {
    ...
    public ExtrusionStyle(int level, int colorSide, int colorTop, int colorLine, float hsvHue, float hsvSaturation, float hsvValue, int defaultHeight) {
        this.level = level;
        ...
        this.hsv = new Color.HSV(hsvHue, hsvSaturation, hsvValue);
