...
public class MarkerRendererCluster extends MarkerRenderer {
    ...
    public MarkerRendererCluster(MarkerLayer<MarkerInterface> markerLayer, MarkerSymbol defaultSymbol, @Nullable MarkerRendererCluster.ClusterStyle style) {
...
//                  if (LOG) Log.v(TAG, "Clustered item at " + itemGridIndex + ", \'parent\' size " + (tmp[storedIndexInGridSlot].clusterSize));
    ...
    public static MarkerRendererFactory factory(final MarkerSymbol defaultSymbol, @Nullable final ClusterStyle style) {
        return new MarkerRendererFactory() {
            @Override
            public MarkerRenderer create(MarkerLayer markerLayer) {
                return new MarkerRendererCluster(markerLayer, defaultSymbol, style);
            }
        };
    }
}
