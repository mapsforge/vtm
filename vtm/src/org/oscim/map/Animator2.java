...
public class Animator2 extends Animator{
    static final Logger log = LoggerFactory.getLogger(Animator2.class);
    ...
    public void animateFling(float velocityX, float velocityY,
        ...
        kineticScroll(velocityX, velocityY, xmin, xmax, ymin, ymax);
    }
    ...
    public void kineticScroll(float velocityX, float velocityY,
        ...
        animEaseStart(duration, ANIM_KINETIC | ANIM_MOVE, Easing.Type.SINE_OUT);
    }
    ...
    protected void animEaseStart(float duration, int state, Easing.Type easingType) {
        animStart(duration, state, easingType);
    }

    protected void animFlingStart(int state) {
        if (!isActive())
