...
- ViewController refactor
  - `ViewController.setMapViewCenter` updated : set `pivotX` and `pivotY` parameters instead of only `pivotY`
  - `ViewController.getMapViewCenter` updated : return an array of [pivotX, pivotY]
