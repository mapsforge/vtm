...
public class MapsforgeTest extends GdxMapApp {
    ...
    public void createLayers() {
        ...
        if (demFolder != null) {
            ...
            final HillshadingTileSource hillshadingTileSource = new HillshadingTileSource(new DemFolderFS(demFolder), algorithm, 128, Color.BLACK, AwtGraphicFactory.INSTANCE);
            mMap.layers().add(new BitmapTileLayer(mMap, hillshadingTileSource));
        }
