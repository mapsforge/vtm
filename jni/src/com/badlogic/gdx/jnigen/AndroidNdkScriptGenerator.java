...
public class AndroidNdkScriptGenerator {
	public void generate (BuildConfig config, BuildTarget target) {
		...
		com.badlogic.gdx.jnigen.FileDescriptor application = config.jniDir.child("Application.mk");
		application.writeString(new com.badlogic.gdx.jnigen.FileDescriptor("resources/scripts/Application.mk.template",
			FileType.Classpath).readString(), false);

		// create Android.mk file
		String template = new com.badlogic.gdx.jnigen.FileDescriptor("resources/scripts/Android.mk.template", FileType.Classpath)
			.readString();
