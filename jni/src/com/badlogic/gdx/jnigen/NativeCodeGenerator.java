...
public class NativeCodeGenerator {
    ...
    String[] includes;
    String[] excludes;
    com.badlogic.gdx.jnigen.AntPathMatcher matcher = new AntPathMatcher();
    ...
    private void processDirectory(com.badlogic.gdx.jnigen.FileDescriptor dir) throws Exception {
        ...
        for (com.badlogic.gdx.jnigen.FileDescriptor file : files) {
            if (file.isDirectory()) {
                ...
                if (file.extension().equals("java")) {
                    ...
                    com.badlogic.gdx.jnigen.FileDescriptor hFile = new com.badlogic.gdx.jnigen.FileDescriptor(jniDir.path() + "/" + className + ".h");
                    ...
                    if (javaContent.contains(JNI_METHOD_MARKER)) {
                        ...
                        com.badlogic.gdx.jnigen.FileDescriptor redirectFileDescripter = new com.badlogic.gdx.jnigen.FileDescriptor();
    ...
    private String getFullyQualifiedClassName(com.badlogic.gdx.jnigen.FileDescriptor file) {
        String className = file.path().replace(sourceDir.path(), "").replace('\\', '.').replace('/', '.').replace(".java", "");
        if (className.startsWith(".")) className = className.substring(1);
        return className;
    }

    private void generateHFile(com.badlogic.gdx.jnigen.FileDescriptor file) throws Exception {
    ...
    private void generateCppFile(ArrayList<JavaSegment> javaSegments, com.badlogic.gdx.jnigen.FileDescriptor hFile, FileDescriptor cppFile)
            throws Exception {
