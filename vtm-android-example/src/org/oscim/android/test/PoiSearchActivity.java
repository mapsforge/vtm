...
public class PoiSearchActivity extends MapsforgeActivity implements ItemizedLayer.OnItemGestureListener<MarkerItem> {
    ...
    private void initSearch() {
        final List<Pattern> search_patterns = new ArrayList<>();

        final PatternAdapter adapter = new PatternAdapter(this, search_patterns);
        ...
        addItem.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                search_patterns.add(new Pattern("", ""));
    ...
    private class Pattern {
        ...
        public Pattern(String key, String val) {
            this.key = key;
            this.val = val;
        }
    }
    ...
    private class PatternAdapter extends ArrayAdapter<Pattern> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            PatternTextWatcher keyPtw = new PatternTextWatcher(pattern, true);
            etKey.setTag(keyPtw);
            etKey.addTextChangedListener(keyPtw);

            etValue.removeTextChangedListener((PatternTextWatcher) etValue.getTag());
            etValue.setText(pattern.val);
            keyPtw = new PatternTextWatcher(pattern, false);
            etValue.setTag(keyPtw);
            etValue.addTextChangedListener(keyPtw);
    ...
    class PatternTextWatcher implements TextWatcher {
    ...
    private class PoiSearchTask extends AsyncTask<BoundingBox, Void, Collection<PointOfInterest>> {
        ...
        protected void onPostExecute(Collection<PointOfInterest> pointOfInterests) {
            ...
            Toast.makeText(activity, (category == null ? "Results" : category) + ": "
