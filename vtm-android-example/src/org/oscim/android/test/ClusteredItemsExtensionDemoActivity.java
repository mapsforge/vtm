...
import org.oscim.layers.marker.MarkerRendererCluster;
import org.oscim.layers.marker.MarkerSymbol;
import org.oscim.theme.VtmThemes;

import java.util.ArrayList;

public class ClusteredItemsExtensionDemoActivity extends BaseMapActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ItemizedLayer layer = new ItemizedLayer(
                mMap,
                MarkerRendererCluster.factory(null, new MarkerRendererCluster.ClusterStyle(0xffffffff, 0xff123456))
        );
